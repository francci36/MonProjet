                                ...
                                <div class="container">
                                    ...
                                    <div
                                        ...
                                        <ul
                                            ...
                                            <li>
                                                <a href="index.php" class="<?php echo ($_SERVER['PHP_SELF'] == '/index.php'); ?>nav-link  px-2 link-dark" >Sobre mim</a>
                                            </li>
                                            <li>
                                                <a href="blog.php" class="<?php echo ($_SERVER['PHP_SELF'] == '/blog.php'); ?>nav-link px-2 link-dark ">Blog</a>
                                            </li>
                                            <li>
                                                <a href="newsletter.php" class="<?php echo ($_SERVER['PHP_SELF'] == '/newsletter.php'); ?>nav-link px-2 link-dark">Newsletter</a>
                                            </li>
                                            <li>
                                                <a href="agendamento.php" class="<?php echo ($_SERVER['PHP_SELF'] == '/agendamento.php'); ?>nav-link px-2 link-dark">Agendamento</a>
                                            </li>
                                            <li>
                                                <a href="login.php" class="<?php echo ($_SERVER['PHP_SELF'] == '/login.php'); ?>nav-link px-2 link-dark">Login</a>
                                            </li>
